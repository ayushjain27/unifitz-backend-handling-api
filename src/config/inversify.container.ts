...
container
  .bind<ReportRoadAccidentService>(TYPES.ReportRoadAccidentService)
  .to(ReportRoadAccidentService);
container
  .bind<ReportRoadAccidentController>(TYPES.ReportRoadAccidentController)
  .to(ReportRoadAccidentController);

container
  .bind<RazorPayService>(TYPES.RazorPayService)
  .to(RazorPayService);
container
  .bind<RazorPayController>(TYPES.RazorPayController)
  .to(RazorPayController);

container
  .bind<ParkAssistService>(TYPES.ParkAssistService)
  .to(ParkAssistService);
container
