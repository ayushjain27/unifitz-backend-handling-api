...
app.get('/createPdf', async (req, res) => {
  ...
  // doc.fontSize(10).text('Your Footer Text Here', 50, 750, { align: 'center' });
  ...
  // doc
  //   .fontSize(24)
  //   .text('INVOICE', 400, doc.y - 3, { width: 100, align: 'right' });
  // doc.fontSize(12).text(`Invoice No: ${invoiceNumber}`, 350, doc.y, {
  //   width: 150,
  //   align: 'right'
  // });
  // doc.fontSize(12).text(`Invoice Date: ${invoiceDate}`, 395, doc.y, {
  //   width: 150,
  //   align: 'right'
  // });
