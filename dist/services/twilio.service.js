...
let TwilioService = class TwilioService {
    constructor(client) {
        this.twilioServiceId = constants_1.twilioConfig.SERVICE_ID;
        this.client = client;
    }
    /* eslint-disable */
    sendVerificationCode(phoneNumber, channel) {
        return __awaiter(this, void 0, void 0, function* () {
            return yield this.client.verify
    ...
    verifyCode(phoneNumber, code) {
        return __awaiter(this, void 0, void 0, function* () {
            const res = yield this.client.verify
                .services(this.twilioServiceId)
